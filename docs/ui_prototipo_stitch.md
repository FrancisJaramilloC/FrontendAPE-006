...
Este documento describe el flujo de usuario cubierto por las 8 pantallas principales del prototipo de la aplicación Stitch.

## Descripción general del flujo
El usuario puede autenticarse, explorar artículos, gestionar sus propios artículos, comunicarse con otros usuarios y administrar su perfil. El flujo está diseñado para facilitar el intercambio de artículos de manera intuitiva y segura.
...
> Las capturas de pantalla deben ser agregadas en la carpeta `/docs/img/` y referenciadas en cada sección correspondiente.
